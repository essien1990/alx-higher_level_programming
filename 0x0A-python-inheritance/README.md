# Inheritance
**ALX SE Project** - Python - Inheritance(superclass,subclass)
...
| `1-my_list.py` | Class `MyList` that inherit is from `list` |
...
| `8-rectangle.py` | Class `Rectangle` that inherit is from `BaseGeometry` |
| `9-rectangle.py` | Class `Rectangle` that inherit is from `BaseGeometry`, with `area()` method implemented |
| `10-square.py` | Class `Square` that inherits from `Rectangle` |
| `11-square.py` | Class `Square` that inherits from `Rectangle`, with `str()` method |
| `100-my_int.py` | Class `MyInt` that inherit is from `int`. Its `==` and `!=` operators are inverted |
